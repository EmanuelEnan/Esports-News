...
class ApiService {
  ...
  Future<List<ApiModelRecentSearch>> getAllData() async {
    // var slug = searchTerm;
    String url =
        'https://api.twitter.com/2/tweets/search/recent?query=${'apex'} lang:en -is:retweet  &max_results=100&tweet.fields=conversation_id,created_at,id,possibly_sensitive,public_metrics,reply_settings,text,withheld&expansions=author_id,referenced_tweets.id&user.fields=profile_image_url';

    String fileName = 'userdata.josn';
